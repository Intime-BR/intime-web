...
export type { ClassInterface as Class } from './classInterface'
export type {Justifications as Justifications} from './justificationInterface'
export type {DailyAbsenceInterface as DailyAbsenceChart } from './dailyAbsenceInterface'
